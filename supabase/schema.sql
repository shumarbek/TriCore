...
create policy "Admin can insert lesson content" on public.lesson_content for insert with check (public.is_admin());
create policy "Admin can update lesson content" on public.lesson_content for update using (public.is_admin());
create policy "Admin can delete lesson content" on public.lesson_content for delete using (public.is_admin());
...
create index if not exists idx_lesson_content_scope on public.lesson_content(subject_id, section_id, sub_section_id);
